<div class="text-secondary-500">
    ...
    <x-button x-data @click="setTimeout(() => document.querySelector('#input-edit-name-{{ $pensum->id }}').focus(), 400);" class="bg-blue-100 text-blue-500 hover:scale-105 transition-all p-2 rounded-lg self-end" wire:click="$set('open', true)">
